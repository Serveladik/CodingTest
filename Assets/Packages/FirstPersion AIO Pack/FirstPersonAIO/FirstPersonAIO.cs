    ...
    private void Start(){
        ...
        if(autoCrosshair || drawStaminaMeter){
            ...
            if(autoCrosshair){
                ...
                crossHair.color = new Color(0f,100f,33f);
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Movement Setup
            ...
            if(showAdvanced){
                ...
                EditorGUILayout.Space();
                t.advanced.FOVKickAmount = EditorGUILayout.Slider(new GUIContent("FOV Kick Amount","Determines how much the camera's FOV will kick upon entering a sprint."),t.advanced.FOVKickAmount,0,60);
